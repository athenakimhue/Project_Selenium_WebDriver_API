...
public class Topic_04_Handle_Textbox_Text_Area_Button {
	WebDriver driver;
	String emailAddress, name, gender, dob, address, city, state, pincode, telephone, emailid, password;  
	...
	public void TC_01() throws InterruptedException {
		...
		Assert.assertEquals(find(By.xpath("//td[contains(text(),'Birthdate')]/following-sibling::td")).getText(), dob);
